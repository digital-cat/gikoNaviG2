...
#### 2026/03/08 ﾊﾞﾀ75(1.76.0.922)
- ５ちゃんねるドメイン変更対応
- 起動時UPLIFT自動ログイン不具合修正
- まちBBS仕様変更対応

#### 2025/08/29 ﾊﾞﾀ75(1.76.0.921)
- 起動時にCookieの期限が伸びる不具合修正
- UPLIFTログイン・ログアウト処理変更
- OpenSSL 3.5.2に更新（OpenSSL3版）
- ID数表示機能不具合修正

#### 2025/07/06 ﾊﾞﾀ75(1.76.0.920)
- IDのNGワード追加機能不具合修正
